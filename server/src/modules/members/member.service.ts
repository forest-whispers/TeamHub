...
export const getMembers = async (requesterId: string, workspaceId: string) => {
    await ensureWorkspaceMember(requesterId, workspaceId);

    const members = prisma.workspaceMember.findMany({
        where: { workspaceId },
...
export const getMember = async ( requesterId: string, workspaceId: string, targetUserId: string ) => {
    await ensureWorkspaceMember(requesterId, workspaceId);
