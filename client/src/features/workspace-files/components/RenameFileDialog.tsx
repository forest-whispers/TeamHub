...
export function RenameFileDialog({
  ...
  const isNameTooLong = trimmedName.length > 255
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs pt-1">
              Enter a new display name for your file.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-1.5">
            ...
            {isNameEmpty && name.length > 0 && (
              <p className="text-[10px] text-destructive">File name cannot be blank.</p>
            )}
            {trimmedName.length > 255 && (
              <p className="text-[10px] text-destructive">File name cannot exceed 255 characters.</p>
            )}
          </div>
